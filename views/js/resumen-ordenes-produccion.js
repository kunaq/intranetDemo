...
var listaColumTblOrdProd = [ 
  ...
  {"targets": 4,"className": "tblOrdProdWidthFchEtg text-center"},
];
// AUMENTO LAS COLUMNAS DE ACUERDO DE AREAS
var numColumTblOrdProd = 3;
...
var table = $("#tablaListaOrdProd").DataTable({
  "ajax": 'ajax/datatable-ResumenOP.ajax.php?fechaInicial='+$("#filtroFInicialOrdProd").val()+'&fechaFinal='+$("#filtroFFinalOrdProd").val()+'&listAreas='+$("#codigoAreasOrdProd").val()+'&estado='+$("#filtroEstadoOrdProd").val()+'&fechaValidada='+$("#filtroFchValidadaOrdProd").val()+'&entrada=tabResumenOP',
  "deferRender": true,
  "retrieve": true,
  "processing": true,
  "language" : {
...
$("#filtroEstadoOrdProd").change(function(){
  table.ajax.url('ajax/datatable-ResumenOP.ajax.php?fechaInicial='+$("#filtroFInicialOrdProd").val()+'&fechaFinal='+$("#filtroFFinalOrdProd").val()+'&listAreas='+$("#codigoAreasOrdProd").val()+'&estado='+$("#filtroEstadoOrdProd").val()+'&fechaValidada='+$("#filtroFchValidadaOrdProd").val()+'&entrada=tabResumenOP').load();
});
/*=============================================
FILTRO POR ESTADOS
=============================================*/
...
$('#daterange-btn-ordProd').daterangepicker(
  ...
  function (start, end) {
    ...
    table.ajax.url('ajax/datatable-ResumenOP.ajax.php?fechaInicial='+fechaInicial+'&fechaFinal='+fechaFinal+'&listAreas='+$("#codigoAreasOrdProd").val()+'&estado='+$("#filtroEstadoOrdProd").val()+'&fechaValidada='+$("#filtroFchValidadaOrdProd").val()+'&entrada=tabResumenOP').load();
  }
)//daterangepicker
cb(start,end);
/*=============================================
...
$(".daterangepicker.opensleft .range_inputs .cancelBtn").on("click", function(){
  ...
  table.ajax.url('ajax/datatable-ResumenOP.ajax.php?listAreas='+$("#codigoAreasOrdProd").val()+'&estado='+$("#filtroEstadoOrdProd").val()+'&fechaValidada='+$("#filtroFchValidadaOrdProd").val()+'&entrada=tabResumenOP').load();
});//click .cancelBtn
/*=============================================
CAPTURAR HOY
=============================================*/
$(".daterangepicker.opensleft .ranges li").on("click", function(){
  ...
  if(textoHoy == "Hoy"){
    if(textoHoy2 == 'Rango de fecha'){
      ...
      $("#filtroFInicialOrdProd").val(fechaInicial);
      $("#filtroFFinalOrdProd").val(fechaFinal);
      table.ajax.url('ajax/datatable-ResumenOP.ajax.php?fechaInicial='+fechaInicial+'&fechaFinal='+fechaFinal+'&listAreas='+$("#codigoAreasOrdProd").val()+'&estado='+$("#filtroEstadoOrdProd").val()+'&fechaValidada='+$("#filtroFchValidadaOrdProd").val()+'&entrada=listadoPrincipal').load();
    }//if
  }//if
...
function mostrarDetalleAreaOrdPrd(localidad,ordenProduccion,lineaOrdenDeatlle,producto,area){
  ...
  $("#tblAreaOrdProdModal").DataTable({
    "ajax": 'ajax/datatable-ResumenOP.ajax.php?localidad='+localidad+'&numOrdenProd='+ordenProduccion+'&lineaOrdenDetalle='+lineaOrdenDeatlle+'&productoAreaOrdProd='+producto+'&areaOrdProd='+area+'&entrada=datatableDetalleOrdProdArea',
    "deferRender": true,
    "retrieve": true,
    "processing": true,
    "scrollY": "200px",
          ...
          success:function(respuesta){
            ...
            if(respuesta == 'mayor'){
              ...
              swal({
                ...
                table.ajax.url('ajax/datatable-ResumenOP.ajax.php?fechaInicial='+$("#filtroFInicialOrdProd").val()+'&fechaFinal='+$("#filtroFFinalOrdProd").val()+'&listAreas='+$("#codigoAreasOrdProd").val()+'&estado='+$("#filtroEstadoOrdProd").val()+'&fechaValidada='+$("#filtroFchValidadaOrdProd").val()+'&entrada=tabResumenOP').load(); $("#formAreaOrdProd [data-dismiss=modal]").trigger("click");
              });
            }//if
          }//success
        });//ajax
