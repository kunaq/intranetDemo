...
(function($){
    ...
    $.fn.email_multiple = function(options) {
        ...
        {
            $(this).after("<span class=\"to-input\" style=\"display:none; \">Email :</span>\n" +
                "<div class=\"all-mail\"></div>\n" +
                "<input type=\"text\" name=\"email\" class=\"enter-mail-id\" style=\"border-radius:0px; box-shadow:none; height:34px; padding:6px 12px; font-size:14px; border-color: #d2d6de; border: 1px solid #ccc;  \" placeholder=\"Enter Email ...\" />");
            let $orig = $(this);
